...
def main():
    ...
    print("Enter the savings account balance, interest rate, and months to maturity.")
    savings_balance = float(input("Enter the savings account balance: "))
    savings_interest = float(input("Enter the interest rate: "))
    savings_maturity = int(input("Enter the months to maturity: "))
    ...
    print("Enter the CD account balance, interest rate, and months to maturity.")
    cd_balance = float(input("Enter the CD account balance: "))
    cd_interest = float(input("Enter the interest rate: "))
    cd_maturity = int(input("Enter the months to maturity: "))
